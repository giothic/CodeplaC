    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/users/destroy/{matricula}").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/ranking/list").permitAll()
                        .requestMatchers(HttpMethod.GET, "/ranking/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/ranking/modify/{id}").permitAll()
